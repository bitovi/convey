...
describe('buildArgsUrl', () => {
  test('builds basic URL without args', () => {
    expect(buildArgsUrl('components-button--primary'))
      .toBe('/storybook/iframe.html?id=components-button--primary&viewMode=story&convey-ghost=1');
  });

  test('appends single arg', () => {
    expect(buildArgsUrl('components-button--primary', { variant: 'secondary' }))
      .toBe('/storybook/iframe.html?id=components-button--primary&viewMode=story&convey-ghost=1&args=variant:secondary');
  });
  ...
  test('appends multiple args separated by semicolons', () => {
    ...
    expect(url).toBe(
      '/storybook/iframe.html?id=components-button--primary&viewMode=story&convey-ghost=1&args=variant:secondary;children:Cancel'
    );
  });
  ...
  test('skips null and undefined values', () => {
    ...
    expect(url).toBe('/storybook/iframe.html?id=test--story&viewMode=story&convey-ghost=1&args=color:red');
  });

  test('returns URL without args param when args object is empty', () => {
    expect(buildArgsUrl('test--story', {}))
      .toBe('/storybook/iframe.html?id=test--story&viewMode=story&convey-ghost=1');
  });

  test('uses custom base path', () => {
    expect(buildArgsUrl('test--story', {}, '/custom'))
      .toBe('/custom/iframe.html?id=test--story&viewMode=story&convey-ghost=1');
  });
});
